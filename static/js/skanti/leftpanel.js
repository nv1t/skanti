...
var skanti = (function (skanti) {
    ...
    LeftPanel.prototype.create_children = function () {
        this.notebook_section = new skanti.NotebookSection('div#notebook_section');
        if (! skanti.read_only){
            this.cell_section = new skanti.CellSection('div#cell_section');
            this.config_section = new skanti.ConfigSection('div#config_section');
        }
        this.help_section = new skanti.HelpSection('div#help_section');
    };
