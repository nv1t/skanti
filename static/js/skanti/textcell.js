...
var skanti = (function (skanti) {
    ...
    TextCell.prototype = new skanti.Cell();
    ...
    TextCell.prototype.bind_events = function () {
        skanti.Cell.prototype.bind_events.apply(this);
        var that = this;
    ...
    var HTMLCell = function (notebook) {
        ...
        skanti.TextCell.apply(this, arguments);
        this.cell_type = 'html';
    };
    ...
    MarkdownCell.prototype.render = function () {
        if (this.rendered === false) {
            var text = this.get_source();
            if (text === "") { text = this.placeholder; }
            var html = skanti.markdown_converter.makeHtml(text);
    ...
    skanti.TextCell = TextCell;
    skanti.HTMLCell = HTMLCell;
    skanti.MarkdownCell = MarkdownCell;
    skanti.RSTCell = RSTCell;
